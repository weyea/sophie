...
import {setAttribute, removeAttribute} from 'node_modules/deku/src/dom/setAttribute'
import { diff,vnode} from 'deku'
...
var diffNode = diff.diffNode;
var isThunk = vnode.isThunk;
var createPath = vnode.createPath;
